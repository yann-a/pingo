...
func ocamlToLambda(lexpr lambda.Lambda) lambda.Lambda {
	switch v := lexpr.(type) {
		...
		case lambda.Read:
			return lambda.Lapp{lambda.Lfun{"thisvarshouldnotbeused", lambda.Read{v.Var, lambda.Lvar("thisvarshouldnotbeused"), ocamlToLambda(v.Then)}}, v.Ref}
		case lambda.Write:
			return lambda.Lapp{lambda.Lfun{"thisvarshouldnotbeused", lambda.Write{lambda.Lvar("thisvarshouldnotbeused"), v.Val, ocamlToLambda(v.Then)}}, v.Ref}
		case lambda.Swap:
			return lambda.Lapp{lambda.Lfun{"thisvarshouldnotbeused", lambda.Swap{v.Var, lambda.Lvar("thisvarshouldnotbeused"), v.Val, ocamlToLambda(v.Then)}}, v.Ref}
		case lambda.New:
